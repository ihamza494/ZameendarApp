...
function SideBar2() {
  ...
  <a  href="/farmer"><img src={former}/><p style={{marginBottom:'-1rem',color:"whitesmoke"}}>Farmer</p></a>
  ...
  <a  href="/dasboard"><img src={logout}/><p style={{marginBottom:'-1rem',color:"whitesmoke"}}>Logout</p></a>
